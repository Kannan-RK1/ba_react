...
const LocalEventDetail = () => {
  ...
  useEffect(() => {
    const fetchEventData = async () => {
      try {
        const eventRef = doc(db, "movies", eventId);
      ...
      <Container className=" pt-3">
        ...
        >
          ...
          <Col sm={12} md={8} lg={10} className="mt-3">
            <p className="text-danger">{eventData.language}</p>
            ...
            <h6>
              <strong>
                ...
                >
                  <path
                    fill="currentColor"
                    d="M224 0C100.3 0 0 100.3 0 224s100.3 224 224 224 224-100.3 224-224S347.7 0 224 0zm121.9 286.1L208 256V136c0-13.3-10.7-24-24-24s-24 10.7-24 24v120c0 4.4 3.6 8 8 8s8-3.6 8-8V272l113.9 19.1c7.9 1.3 14.2-5 14.2-12.9 0-6.1-4.5-11.1-10.3-12l-.8-.1c-6.6-.8-12.6 3.7-15.5 9.9z"
                  ></path>
                </svg>
              </strong>{" "}
              {eventData.duration}
        ...
        >
          <Col md={3}>
            <h6 className="fw-bolder">Production</h6>
            {eventData.production}
          </Col>
          <Col md={3}>
            <h6 className="fw-bolder">Release Date</h6>
            {eventData.releaseDate}
          </Col>
          <Col md={3}>
            <h6 className="fw-bolder ">Subtitle</h6>
            {eventData.subtitles}
          </Col>
          <Col md={3}>
            <h6 className="fw-bolder ">Origin From</h6>
            {eventData.country}
          </Col>
        </Row>
